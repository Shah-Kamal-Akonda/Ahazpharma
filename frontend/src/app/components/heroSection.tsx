...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 w-full md:w-1/2 backdrop-blur-md flex items-center justify-center p-6 md:p-12">
        <motion.div
        ...
        >
          ...
          <p className="text-white text-md md:text-lg leading-relaxed max-w-md drop-shadow-sm">
